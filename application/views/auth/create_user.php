	    ...
	    <div class="box">
	      ...
	      <div class="box-body">
	        ...
	        <div class="form-group">
	          <?php echo lang('create_user_nik_label', 'nik', array('class' => 'control-label col-md-3')); ?>
	          <div class="col-md-7">
	        ...
	        <div class="form-group">
	          <?php echo lang('create_user_jabatan_label', 'last_name', array('class' => 'control-label col-md-3')); ?>
	          <div class="col-md-7">
	        ...
	        <div class="form-group">
	          <?php echo lang('create_user_alamat_label', 'alamat', array('class' => 'control-label col-md-3')); ?>
	          <div class="col-md-7">
	        ...
	        <div class="form-group">
	          <?php echo lang('create_user_tlahir_label', 'tgl_lahir', array('class' => 'control-label col-md-3')); ?>
	          <div class="col-md-7">
