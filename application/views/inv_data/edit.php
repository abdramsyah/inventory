		...
		<div class="box">
			...
			<div class="box-body" id="edit_data">
				...
				<?php foreach ($data_list->result() as $data) {
					...
					$curr_rusak        	   = $data->tgl_rusak;
					$curr_benar        	   = $data->tgl_benar;
				} ?>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<form id="input_form" action="<?php echo base_url('inventory/edit/') . $code ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
						...
						<fieldset>
							...
							<div class="form-group">
								<label for="tgl_rusak" class="control-label col-md-2">Tanggal Repair</label>
								<div class="col-md-4">
									<input type="date" name="tgl_rusak" id="tgl_rusak" class="form-control" value="<?php echo $curr_rusak; ?>">
								</div>
							</div>
							<div class=" form-group">
								<label for="tgl_benar" class="control-label col-md-2">Tanggal Selesai Repair</label>
								<div class="col-md-4">
									<input type="date" name="tgl_benar" id="tgl_benar" class="form-control">
								</div>
							</div>
							<div class="form-group">
